<%-- 
    Document   : resvolunter
    Created on : May 25, 2020, 3:34:56 PM
    Author     : user
--%>
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="resvolunteer.jsp">register</a>
		...
		<div class="col-md-9">
		    <div class="card">
		        <div class="card-body">
		            <div class="row">
		                <div class="col-md-12">
		                    <h4>Form Registetration Volunteer</h4>
		                    <hr>
		                </div>
		            </div>
		            <div class="row">
		                <div class="col-md-12">
                                ...
                                <label for="username" class="col-4 col-form-label">ID Voulunteer*</label> 
                                <div class="col-8">
                                  <input name="volunteer" placeholder="id volunteer" class="form-control here" required="required" type="text" >
                                </div>
                              </div>
                              <div class="form-group row">
                                ...
                                <div class="col-8">
                                  <input name="name" placeholder="Name" class="form-control here" required="required" type="text" >
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="name" class="col-4 col-form-label">IC</label> 
                                <div class="col-8">
                                  <input  name="ic" placeholder="IC" class="form-control here" type="text">
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="lastname" class="col-4 col-form-label">No.Phone</label> 
                                <div class="col-8">
                                  <input  name="phone" placeholder="No.phone" class="form-control here" type="text">
                                </div>
                              </div>
                                <div class="form-group row">
                                <label for="name" class="col-4 col-form-label">Age</label> 
                                <div class="col-8">
                                  <input  name="age" placeholder="Age" class="form-control here" type="text">
                                </div>
                              </div>
                                <div class="form-group row">
                                <label for="name" class="col-4 col-form-label">Categori</label> 
                                <div class="col-8">
                                  <input  name="category" placeholder="category" class="form-control here" type="text">
                                </div>
                              </div>
                                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <input id="myText" name="password"  class="form-control here" type="hidden" value="">
                                </div>
                              </div> 
                              <div class="form-group row">
                                <div class="offset-4 col-8">
                                  <button name="Submit" type="submit" class="btn btn-primary" value="Register" onclick="myFunction()">Register</button>
                                </div>
                              </div>
                            </form>
		                </div>
