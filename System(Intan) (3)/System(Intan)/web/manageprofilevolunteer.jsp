<%-- 
    Document   : manageprofilevolunteer
    Created on : May 27, 2020, 4:03:35 PM
    Author     : user
--%>
...
<script>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <% 
                ...
                sukarelawan e = DAO.getvolunteerBySession((String)session.getAttribute("user"));
		            ...
		            <div class="row">
		                <div class="col-md-12">
                              ...
                              <div class="form-group row">
                                  <input name="id"  class="form-control here" required="required" type="hidden" value="<%=e.getIdsukarelawan() %>">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-8">
                                  <input  name="phone" placeholder="No.phone" class="form-control here" type="text" value="<%=e.getPhone() %>">
                                </div>
                              </div>
                                        <div class="form-group row">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-8">
                                  <input id="text" name="city" placeholder="city" class="form-control here" required="required" type="text" value="<%=e.getCity() %>">
                                </div>
                              </div>
                            <div class="form-group row">
                              ...
                              <div class="form-group row">
                                <div class="offset-4 col-8">
                                  <button name="Submit" type="submit" class="btn btn-primary" value="Update Profile">Update My Profile</button>
                                </div>
                              </div>
                            </form>
		                </div>
